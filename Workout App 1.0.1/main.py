...
#All the entry fields for the user to enter in values, left open to alphanumeric in case user wants to input four instead of 4
wo_name = tk.Entry(g.window, textvariable=wo_var, width=10)
wo_name.grid(column=1, row=2)
